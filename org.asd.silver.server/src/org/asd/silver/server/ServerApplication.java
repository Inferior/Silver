 ...
 * org.eclipse.equinox.http.jetty.context.path=/silver_server
 ...
 * eclipse.product=org.asd.silver.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("silver server initialized");
    return EXIT_OK;
  }
