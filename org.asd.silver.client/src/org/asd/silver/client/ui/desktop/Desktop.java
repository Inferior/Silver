package org.asd.silver.client.ui.desktop;

import java.util.Set;

import org.asd.silver.client.ClientSession;
import org.asd.silver.client.alpha.NewCompanyForm;
import org.asd.silver.client.gamma.PartsLibraryForm;
import org.asd.silver.client.ui.forms.DesktopForm;
import org.asd.silver.shared.Icons;
...
public class Desktop extends AbstractExtensibleDesktop implements IDesktop {
  ...
  @Order(20.0)
  public class LibraryMenu extends AbstractExtensibleMenu {

    @Override
    protected String getConfiguredText() {
      return TEXTS.get("Library");
    }

    @Order(10.0)
    public class PartsMenu extends AbstractExtensibleMenu {
      ...
      protected void execAction() throws ProcessingException {
        PartsLibraryForm form = new PartsLibraryForm();
        form.startNew();
      }
    }
  }
  ...
  @Order(30.0)
  public class DirectoryMenu extends AbstractExtensibleMenu {
