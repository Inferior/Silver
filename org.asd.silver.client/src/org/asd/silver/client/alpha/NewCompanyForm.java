...
import org.asd.silver.client.alpha.NewCompanyForm.MainBox.ApprovalBox.ApprovalTypeField;
import org.asd.silver.client.alpha.NewCompanyForm.MainBox.ApprovalBox.CompanySpecificApprovalGroup;
import org.asd.silver.client.alpha.NewCompanyForm.MainBox.ApprovalBox.ScopeOfApprovalField;
...
import org.asd.silver.shared.delta.ApprovalScopeCodeType;
...
import org.asd.silver.shared.delta.CompanySpecificApprovalCodeType;
...
public class NewCompanyForm extends AbstractForm {
  ...
  /**
   * @return the CompanySpecificApprovalGroup
   */
  public CompanySpecificApprovalGroup getCompanySpecificApprovalGroup(){
    return getFieldByClass(CompanySpecificApprovalGroup.class);
  }
  ...
  public class MainBox extends AbstractGroupBox {
    ...
    public class ApprovalBox extends AbstractGroupBox {
      ...
      public class ApprovalTypeField extends AbstractSmartField<Integer> {
        ...
        @Override
        protected Class<? extends ICodeType<?, Integer>> getConfiguredCodeType() {
          return ApprovalScopeCodeType.class;
        }
      ...
      @Order(50.0)
      public class CompanySpecificApprovalGroup extends AbstractRadioButtonGroup<Integer> {

        @Override
        protected Class<? extends ICodeType<?, Integer>> getConfiguredCodeType() {
          return CompanySpecificApprovalCodeType.class;
        }
